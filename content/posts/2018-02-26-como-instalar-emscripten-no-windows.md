...
1. Abrir o Prompt de Comando, e executar o arquivo `emsdk_env.bat` que está na pasta do SDK. Isto fará com que todas as variáveis necessárias sejam definidas dentro do prompt atual, mas apenas temporáriamente.
