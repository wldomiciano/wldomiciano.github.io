...
---
Quero deixar registrado aqui que hoje tirei o dia para migrar este blog de [Jekyll](//jekyllrb.com) para [Hugo](//gohugo.io), um outro gerador de sites estáticos.

## O que são geradores de sites estáticos

Diferentes do [WordPress](//wordpress.org) e afins, onde cada página é gerada dinamicamente conforme o usuário faz uma requisição, com geradores estáticos suas páginas são todas geradas antes de serem enviadas para o servidor. Quando o usuário faz uma requisição, o servidor apenas manda esta página pronta como resposta.

Dentre as vantagens destes geradores, destacam-se maior **performance** e **segurança** para o seu site.

## Um pouco de história

Durante anos quis criar um blog e cheguei a mexer com o [Blogger](//blogger.com) e com o WordPress, mas foi com o Jekyll que o desejo se tornou realidade no ano passado.
...
Uma das grandes vantagens do Jekyll é sua integração com o [GitHub Pages](//pages.github.com).

Basta criar um repositório no [GitHub](//github.com/) para o código do seu site e o GitHub Pages o construirá automaticamente e o hospedará.
