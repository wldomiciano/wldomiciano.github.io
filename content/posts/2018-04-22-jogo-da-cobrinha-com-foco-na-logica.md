...
Se comparar os códigos em C e em JavaScript, verá que pouquíssima coisa muda além das função não portáveis, as diferenças maiores ficam por conta de certas palavras chaves e por C ser estáticamente tipada.
